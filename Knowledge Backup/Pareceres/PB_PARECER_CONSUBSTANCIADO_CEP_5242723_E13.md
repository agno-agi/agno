...
Os campos 'Apresentaçªo do Projeto', 'Objetivos da Pesquisa' e 'Avaliaçªo dos Riscos e Benefícios' estªo de acordo com o documento PB\_INFORMA˙ÕES\_B`SICAS\_1887927\_E13.pdf, versªo 16, de 21/01/2022:
...
Continuaçªo do Parecer: 5.242.723
...
Em Carta dirigida ao CEP-INI a pesquisadora responsÆvel envia os documentos com as alteraçıes pretendidas nesta Emenda (E13):
...
- - Adendo ao TCLE versªo final 3.0 de 23 de janeiro de 2020. Este adendo foi adaptado para o INI em 20 de abril de 2021 e modificado pela Carta Emenda 3 em 18 de janeiro de 2022'.

A Carta Emenda 3 (LoA), de 01 de dezembro de 2021, apresenta:

- 'Justificativa para as revisıes e implementaçªo:
...
- 1. Uma pÆgina de assinatura do protocolo foi adicionada de acordo com esta LoA.
- 2. Lista de abreviaturas e acrônimos:
- - ˝ndice de massa corporal e extensªo em rótulo aberto sªo adicionados:
- * IMC - ˝ndice de massa corporal
- * OLE - Extensªo em rótulo aberto
- 3. Integrantes da equipe do protocolo:
- - David Margolis foi removido; Yoshihiko Murata foi adicionado.
- 4. Seçªo 7.8, Atribuiçªo Aleatória:
- - Os parâmetros de raça e etnia foram removidos da estratificaçªo de randomizaçªo. Apenas a parte afetada desta seçªo Ø descrita:
- 'Os participantes incluídos serªo randomizados para um dos dois braços do estudo em uma proporçªo de 1:1. A randomizaçªo serÆ estratificada por centro do estudo e um desenho de blocos permutados serÆ usado para garantir atribuiçıes de tratamento equilibradas dentro do centro do estudo'.
- 5. Anexo V, Parte A, Seçªo 3, Descriçªo das etapas 4 e 5:
- - Foram acrescentadas orientaçıes para obter consentimento de participantes que forem inelegíveis ou nªo quiserem participar da extensªo em rótulo aberto (OLE) sob a versªo 4.0 do protocolo. Os centros devem fornecer as novas informaçıes e obter consentimento de todos os participantes no prazo de seis meses a partir do recebimento da notificaçªo de implementaçªo da Versªo 4.0.
- 6. Anexo V, Parte A, Seçªo 4, Objetivos/desfechos/anÆlise estatística da extensªo em rótulo aberto:
- - A Seçªo 4 da Parte A Ø uma nova seçªo que descreve os objetivos, desfechos e anÆlises estatísticas correspondentes à extensªo em rótulo aberto na Versªo 4.0 do protocolo.
- 7. Anexo V, Parte C, Seçªo 6, Procedimentos para as Etapas 4 e 5 (originalmente Etapas 1 a 3 da Seçªo 5.0, com modificaçıes):
...
- - Foi adicionada referŒncia para a nova Tabela 11 para participantes que receberem as novas informaçıes do estudo, mas nªo continuarem o acompanhamento na Versªo 4.0.
- 8.  Anexo V, Parte C, Seçªo 8, Procedimentos para participantes que nªo concluírem a Etapa 4a (originalmente Etapa 1 da seçªo 5.12 do protocolo principal, com modificaçıes):
- - A Tabela 11 original foi renumerada para Tabela 12.
- 9. Anexo V, Parte C, Seçªo 9, Procedimentos para suspeita ou confirmaçªo de infecçªo por HIV (da Seçªo 5.14.2 do protocolo principal, com modificaçıes):
- - Foi adicionado um esclarecimento para acompanhamento de participantes que tiverem um teste de HIV reagente ou positivo durante a Versªo 4.0.
- 10. Anexo V, Parte C, Seçªo 10, Infecçıes sexualmente transmissíveis (da Seçªo 5.15 do protocolo principal):
- - Foram adicionadas mais orientaçıes com relaçªo aos momentos de teste de IST após a entrada na Versªo 4.0.
- 11. Anexo V, Parte D, Cronogramas de procedimentos e avaliaçıes para as etapas 4a, 4b, 4c e 5, e para participantes que nªo continuarem na Versªo 4.0:
- - O texto foi atualizado para incluir os participantes que receberem as novas informaçıes do estudo, mas nªo continuarem o acompanhamento na Versªo 4.0.
- 12. Anexo V, Parte D, Tabelas 7-12: Cronogramas de procedimentos e avaliaçıes.
- - O rastreamento de IST assintomÆtica foi adicionado no Dia 0 de cada etapa apenas se esse teste nªo tiver sido realizado nos seis meses anteriores do estudo. As notas de rodapØ foram atualizadas para refletir o cronograma de testes de IST, bem como para esclarecer a avaliaçªo de reaçıes no local da injeçªo. A Tabela 8 foi atualizada para permitir 120 dias entre o Dia 0 da Etapa 4a e o Dia 0 da Etapa 4b para acomodar 50% de adesªo ao CAB oral na Etapa 4a. A Tabela 11 Ø uma nova tabela para participantes que nªo continuarem no estudo na Versªo 4.0. A observaçªo da Tabela 12 foi atualizada para esclarecer que os participantes que continuarem na Versªo 4.0 serªo encaminhados para atendimento local se forem diagnosticados com infecçªo pelo HIV na sua visita final.
...
- 13. Anexo V, Seçªo F, Adendo ao Modelo do Termo de consentimento livre e esclarecido principal:
- (a) O rastreamento de ISTs assintomÆticas foi adicionado no Dia 0 de cada etapa apenas se esse teste nªo tiver sido realizado nos seis meses anteriores do estudo. Foram adicionadas notas de rodapØ para refletir o cronograma dos testes de IST.
- (b) Uma nova tabela foi adicionada para a visita final de participantes que receberem as novas informaçıes do estudo, mas nªo continuarem o acompanhamento na Versªo 4.0.
- (c) O texto foi adicionado para esclarecer quais procedimentos serªo realizados na visita final dependendo da participaçªo na Versªo 4.0.
- (d) O texto foi atualizado para esclarecer o acompanhamento de participantes com infecçªo por HIV durante a Etapa 5, dependendo se tiverem recebido alguma injeçªo de CAB.
- (e) A pÆgina de assinatura foi atualizada para refletir as opçıes para os procedimentos da visita final para os participantes que receberem as novas informaçıes do estudo, mas nªo continuarem o acompanhamento na Versªo 4.0.

## COMENT`RIOS - sobre o Adendo ao TCLE:

- a) Nas Tabelas constantes nas pÆginas 4 (Etapa 4a), 5 (Etapa 4b), 6 (Etapa 4c) e 7 (Etapa 5) do TCLE aprovado por este CEP em 31/05/2021 (Parecer Consubstanciado n. 4.746.052), no tópico referente à coleta de sangue para teste de HIV foi acrescentado o teste de sífilis, alØm de outro tópico introduzido visando 'Realizar swab retal e coletar urina para os testes de gonorreia e clamídia'; e a seguinte ressalva foi incluída nos rodapØs:

'Se vocŒ tiver feito testes de sífilis, gonorreia e clamídia dentro de 6 meses após ingressar nesta parte do estudo, este teste nªo serÆ feito no Dia 0, a menos que vocŒ tenha sintomas ou relate uma exposiçªo recente a uma pessoa com alguma dessas infecçıes sexualmente transmissíveis'.

- b) A nova Tabela adicionada na pÆgina 8 do Adendo do TCLE aprovado por este CEP em 31/05/2021 (Parecer Consubstanciado n. 4.746.052) tem o seguinte título: 'Nªo continuar nesta parte do estudo: Cronograma de Procedimentos e Avaliaçıes - Se vocŒ decidir que nªo quer participar desta parte do estudo, ou se tiver completado 3 anos desde a sua data de inclusªo e nªo quiser iniciar o CAB, ou se vocŒ nªo for elegível para participar desta parte do estudo, pediremos que vocŒ realize estes procedimentos na sua visita final'. Os procedimentos sªo os mesmos previstos nas etapas anteriores, exceto aqueles referentes à opçªo por comprimidos.
- c)  No item 'SE VOC˚ SAIR DO ESTUDO ANTES DA SUA VISITA FINAL' (pÆgina 7 do Adendo jÆ aprovado), a frase inicial 'Se vocŒ sair do estudo antes de sua visita final' foi modificada para: 'Se vocŒ ingressou nesta parte do estudo e sair do estudo antes da sua œltima visita do cronograma do
...
d) No item 'Se vocŒ contrair o HIV durante esta parte do estudo' (pÆgina 8 do Adendo jÆ aprovado) foi acrescentado o seguinte texto: 'Se for detectado que vocŒ contraiu o HIV na visita final do estudo ou durante a Etapa 5 e vocŒ jÆ tiver recebido alguma injeçªo de CAB em qualquer momento durante as visitas anteriores, [pediremos que vocŒ volte para uma visita a cada 3 meses por cerca de um ano]; se vocŒ nªo tiver recebido nenhuma injeçªo de CAB durante as visitas anteriores, vocŒ serÆ descontinuado do estudo'. e) Na pÆgina de assinaturas o preâmbulo foi modificado: ao invØs de 'Se vocŒ leu este adendo ao termo (...) e vocŒ concorda em participar deste estudo', a redaçªo foi alterada para 'Se vocŒ leu este adendo ao termo (...) e vocŒ entendeu as informaçıes, coloque suas iniciais na linha apropriada: se vocŒ deseja continuar no estudo, se vocŒ nªo deseja mais continuar no estudo ou se vocŒ nªo Ø elegível para continuar no estudo'.

- As opçıes para colocar as iniciais tambØm foram alteradas para:
- \_\_\_\_ Eu concordo voluntariamente em continuar participando nesta porçªo do estudo.

\_\_\_\_ Eu nªo concordo em participar desta porçªo do estudo, mas concordo com os procedimentos listados na tabela para quem nªo continuar nesta parte do estudo.

\_\_\_\_ Eu nªo concordo em participar desta porçªo do estudo, e nªo concordo com os procedimentos listados na tabela para quem nªo continuar nesta parte do estudo.

\_\_\_\_ Eu entendo que nªo sou elegível para participar desta porçªo do estudo, e concordo com os procedimentos listados na tabela para quem nªo continuar nesta parte do estudo.

\_\_\_\_ Eu entendo que nªo sou elegível para participar desta porçªo do estudo, e nªo concordo com os procedimentos listados na tabela para quem nªo continuar nesta parte do estudo.

Os campos de identificaçªo e assinatura de 'Representante Legalmente Autorizado' foram eliminados.

Vide tópico 'Conclusıes ou PendŒncias e Lista de Inadequaçıes'.

## Consideraçıes sobre os Termos de apresentaçªo obrigatória:

A l Ø m d a C a r t a d e e n c a m i n h a m e n t o a o C E P - I N I e d o d o c u m e n t o PB\_INFORMA˙ÕES\_B`SICAS\_1887927\_E13.pdf,  foram  anexados  à  Plataforma  Brasil: · HPTN\_083\_V4\_Addendum\_ICF\_10Feb2021\_WORD\_Version\_PT\_INI\_LoA3\_18jan22 (versıes: limpa e com alteraçıes);

- • HPTN\_083\_LoA3\_to\_V4\_FINAL\_01Dec2021 (versıes em inglŒs e portuguŒs).
...
As alteraçıes no protocolo contemplam mudanças formais para adequÆ-lo à nova versªo 4.0, aprovada por este CEP conforme Parecer Consubstanciado n. 4.712.654, de 14 de maio de 2021.
...
Nªo hÆ óbice Øtico à aprovaçªo desta Emenda 13.
...
|-----------------------------------------------------------|-----------------------------------------------------------------------------------|---------------------|-----------------------------------|------------|
| Informaçıes BÆsicas do Projeto                            | PB_INFORMA˙ÕES_B`SICAS_188792 7_E13.pdf                                           | 21/01/2022 15:30:09 |                                   | Aceito     |
...
| Justificativa de AusŒncia                                 | 1_Limpo.doc                                                                     | 14/05/2021 16:49:50   | SUE ELLEN LAVINNI DOS SANTOS LIMA   | Aceito   |
|-----------------------------------------------------------|---------------------------------------------------------------------------------|-----------------------|-------------------------------------|----------|
