...
Alguns sinais de que vocŒ possa estar tendo uma reaçªo alØrgica sªo:
...
- 3. O campo do patrocinador na Folha de Rosto estÆ preenchido de maneira inadequada, faltando a identificaçªo do responsÆvel institucional, suas credenciais, a assinatura e a data. Solicita-se reapresentar a folha de rosto.

RESPOSTA: A folha de rosto foi corrigida e a assinatura da parte do patrocinador incluída conforme solicitado.
...
do CNS, manifesta-se pela aprovaçªo do projeto de pesquisa proposto.
...
|-----------------------------------------------------------|-------------------------------------------------------------------------------------------------|---------------------|---------------------------|------------|
| Informaçıes BÆsicas do Projeto                            | PB_INFORMA˙ÕES_B`SICAS_DO_P ROJETO_1941507.pdf                                                  | 28/07/2022 12:26:02 |                           | Aceito     |
