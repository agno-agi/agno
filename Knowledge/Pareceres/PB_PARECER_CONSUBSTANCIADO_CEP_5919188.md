...
## Prezados,
Em atendimento aos questionamentos do CEP, gostaríamos de encaminhar os esclarecimentos para avaliação e submissão ao CEP coordenador do estudo clínico supracitado, conforme segue:
## Recomendações:
Anexar a carta de aprovação do CEP de origem, que está em tramitação, para o início do projeto.
## RESPOSTA A PENDêNCIA:
Segue em anexo as cartas de aprovação do CEP de origem (Reino Unido - Research Ethics Committee London Centre) bem como as aprovações regulatórias aplicáveis ao projeto em suas versões originais, em língua inglesa e traduções ao português.
## Considerações sobre os Termos de apresentação obrigatória:
PB\_INFORMAÇÕES\_BáSICAS\_DO\_PROJETO\_2061827.pdf
