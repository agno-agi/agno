...
1)GLYPH&lt;9&gt;Incluir no projeto as novas estratégias de recrutamento (divulgação em redes sociais) também para o SAG no item ¿D- Triagem e recrutamento de participantes¿ do Objetivo 1a (pág 4) e do objetivo 1b (pág 5).

## Considerações Finais a critério do CEP:
Atendida a pendência, sugiro aprovação ad referendum
...
|-----------------------------------------------------------|-------------------------------------------------------------------------------------------|---------------------|---------------------------|------------|
| Informações Básicas do Projeto                            | PB_INFORMAÇÕES_BáSICAS_243300 6_E2.pdf                                                    | 03/10/2024 16:00:32 |                           | Aceito     |
