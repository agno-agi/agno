...
V1 had: agno.memory.v2.schema with SessionSummary, UserMemory
V2 has: Different structure in agno.memory.manager

This module provides V1-compatible interfaces.
"""
