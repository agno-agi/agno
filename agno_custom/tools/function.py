...
class Function(BaseModel):
    ...
    # NOTE: New feature - allow tool function to specify which downstream agent outputs to include in the function call output, if not set, all are included.
    ...
    def _wrap_callable(func: Callable) -> Callable:
        ...
        # Wrap the callable with validate_call
            ...
            wrapped = validate_call(func, config=dict(arbitrary_types_allowed=True))  # noqa: C408
