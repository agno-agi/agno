...
class ContractReview(BaseModel):
    ...
    title: Optional[str] = Field(
        default=None, description="Contract title if present"
    )
    ...
    redline_suggestions: list[RedlineSuggestion] = Field(
        default_factory=list,
        description="Suggested edits to improve the contract"
    )
    ...
    ambiguous_sections: list[str] = Field(
        default_factory=list,
        description="Sections with ambiguous or unclear language"
    )
