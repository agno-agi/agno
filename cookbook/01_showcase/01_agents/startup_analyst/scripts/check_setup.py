...
2. API keys (OPENAI_API_KEY, SCRAPEGRAPH_API_KEY)
3. Agent import
...
def check_api_keys() -> bool:
    ...
    scrapegraph_key = os.environ.get("SCRAPEGRAPH_API_KEY")
    if scrapegraph_key:
        print(f"   [OK] SCRAPEGRAPH_API_KEY is set ({scrapegraph_key[:8]}...)")
    else:
        print("   [FAIL] SCRAPEGRAPH_API_KEY not set (required for web scraping)")
        print("   -> Run: export SCRAPEGRAPH_API_KEY=your-key")
        print("   -> Get a key at: https://scrapegraph.ai/")
        all_set = False
...
def check_import() -> bool:
    ...
    try:
        ...
        print("   [OK] startup_analyst imported successfully")
        return True
...
def main() -> int:
    ...
    print("=" * 60)
    print("Startup Analyst Tutorial - Setup Check")
    print("=" * 60)
    ...
    if all_passed:
        ...
        print()
        print("Try:")
        print("  python examples/01_analyze_startup.py")
        return 0
    else:
