"""
Tool Call Args Delta — OpenAI Responses
========================================

Stream tool call arguments as they are generated, using OpenAI Responses API.
...
Run with:
    .venvs/demo/bin/python cookbook/02_agents/14_advanced/tool_call_args_delta_openai_responses.py
"""
...
if __name__ == "__main__":
    print("=== OpenAIResponses: ToolCallArgsDelta streaming ===\n")
