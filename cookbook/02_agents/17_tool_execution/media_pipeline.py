"""
Tool Execution — Media Generation Pipeline (Image + Audio)
============================================================
Combines DALL-E (image generation) + ElevenLabs (audio/TTS) in a single
tool execution agent. The model writes a program that:
...
flows correctly through the tool execution media collector without serializing
...
Run: .venvs/demo/bin/python cookbook/02_agents/17_tool_execution/media_pipeline.py
"""
