...
workspace_analyst = Agent(
    ...
    instructions=[
        ...
        "Use search_slack_workspace for topic searches; its action token comes from the Slack event.",
        "Use get_slack_channel_history for a known channel and get_slack_thread to expand important replies.",
