...
(New to this? Read 01_managed_roles.py first. 12_idp_workos_auth0.py shows the same IdP
...
# swap in jwks_file=... and issuer=... exactly as 12_idp_workos_auth0.py does.
