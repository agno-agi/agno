...
- `isolation.py` — Adds opt-in per-user data isolation on top of `basic.py`. Non-admins see only their own data; `agent_os:admin` (or custom `admin_scope`) bypasses isolation.
