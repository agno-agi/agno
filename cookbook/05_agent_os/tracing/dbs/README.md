...
- `basic_agent_with_async_clickhousedb.py` — Same dual-DB pattern but fully async (`AsyncPostgresDb` + `AsyncClickhouseDb`); `setup_tracing` awaits the exporter automatically.
