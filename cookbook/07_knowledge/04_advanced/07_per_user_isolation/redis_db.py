...
Redis stores the owner in a user_id TAG field on each hash; shared chunks
...
Requirements: ./cookbook/scripts/run_redis.sh and OPENAI_API_KEY
Run: python cookbook/07_knowledge/04_advanced/07_per_user_isolation/redis_db.py
"""
...
async def main() -> None:
    ...
    # Start clean; async_drop raises when the index is absent (first run).
    try:
