...
if __name__ == "__main__":
    ...
    alice_acme_details.learning_machine.session_context_store.print(
    ...
    alice_win_factors.learning_machine.learned_knowledge_store.print(
        query="sales"
    )
    alice_win_factors.learning_machine.session_context_store.print(
