...
if __name__ == "__main__":
    ...
    intro.learning_machine.user_profile_store.print(user_id=founder_id)
    ...
    benchmark_outreach.learning_machine.session_context_store.print(
    ...
    benchmark_feedback.learning_machine.session_context_store.print(
        session_id="seed-round"
    )
    ...
    pivot_strategy.learning_machine.learned_knowledge_store.print(query="demo")
    ...
    unusual_insight_pitch.learning_machine.session_context_store.print(
        session_id="seed-round"
    )
    ...
    insight_customers.learning_machine.session_context_store.print(
        session_id="seed-round"
    )
    ...
    reflect_on_learnings.learning_machine.learned_knowledge_store.print(
        query="successful"
    )
    ...
    round_closed.learning_machine.session_context_store.print(
        session_id="seed-round"
    )
    ...
    round_closed.learning_machine.user_profile_store.print(user_id=founder_id)
    round_closed.learning_machine.session_context_store.print(
        session_id="seed-round"
    )
    round_closed.learning_machine.learned_knowledge_store.print(
        query="fundraising"
    )
