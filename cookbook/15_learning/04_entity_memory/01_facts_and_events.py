...
# Fact vs Event Guide
# ============================================================================
def fact_vs_event_guide():
    """Print guide for distinguishing facts from events."""
    print("\n" + "=" * 60)
    print("Guide: Fact or Event?")
    print("=" * 60)
    print("""
FACTS (Semantic Memory):
   - Timeless or long-lasting truths
   ...
   ✓ "Acme uses PostgreSQL"
   ✓ "Bob is CTO of Acme"
   ✓ "The company is based in SF"
   ✓ "They have 50 employees"
   ✓ "They focus on B2B SaaS"
...
EVENTS (Episodic Memory):
   ...
   Examples:
   ✓ "Raised Series A on Jan 10"
   ✓ "Launched v2 last week"
   ✓ "Hired new CTO yesterday"
   ✓ "Opening London office in Q2"
   ✓ "Reached 1000 customers in December"

AMBIGUOUS CASES:
   "They hired Bob as CTO"
   → EVENT (the hiring) + FACT (Bob is CTO)
   
   "They have 50 employees"
   → Usually a FACT (current state)
   → Could be EVENT if "grew to 50 this month"
""")
