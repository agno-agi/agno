...
```shell
python cookbook/90_models/anthropic/basic.py
```
...
```shell
python cookbook/90_models/anthropic/structured_output.py
```

### 7. Run Agent that uses storage

```shell
python cookbook/90_models/anthropic/db.py
```
...
```shell
python cookbook/90_models/anthropic/memory.py
```
...
```shell
python cookbook/90_models/anthropic/thinking.py
```

### 12. Run Agent with Interleaved Thinking

```shell
python cookbook/90_models/anthropic/financial_analyst_thinking.py
```
