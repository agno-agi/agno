...
one argument; the tool names and JSON shapes the agent sees do not change.
...
Setup:
    export FINANCIAL_DATASETS_API_KEY=...   # free keys cover AAPL, GOOGL, NVDA, TSLA
"""
...
# Create the Agent
# ---------------------------------------------------------------------------
finance_tools = FinanceTools(provider="financial_datasets", all=True)
