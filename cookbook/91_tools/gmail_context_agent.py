"""
Gmail Context Agent (Pal Pattern)
==================================
A personal email agent that learns your preferences across sessions.
...
This demonstrates the "Pal" pattern from the Context Agent spec:
an agent that navigates a heterogeneous context graph and improves over time.
