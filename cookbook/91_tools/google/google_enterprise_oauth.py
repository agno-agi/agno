...
# enable_multi_user_oauth=True: on auth failure, returns OAuth URL instead of browser
...
agent = Agent(
    ...
    tools=[
        ...
        GoogleCalendarTools(auth=auth, include_tools=["list_events", "create_event"]),
    ],
    instructions="You are an enterprise assistant with Gmail and Calendar access.",
    markdown=True,
)
