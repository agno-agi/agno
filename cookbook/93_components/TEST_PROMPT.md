# Prompt to test: `cookbook/93_components`

Use this prompt with an AI coding agent to test and validate the components cookbook.
...
1. Run `.venvs/demo/bin/python cookbook/scripts/check_cookbook_pattern.py --base-dir cookbook/93_components --recursive` and fix any violations.
...
5. Update `cookbook/93_components/TEST_LOG.md` and `cookbook/93_components/workflows/TEST_LOG.md` with fresh PASS/FAIL entries per file.
