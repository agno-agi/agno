...
COLLECTION_NAME = "resume-text-test"
...
knowledge_base = TextKnowledgeBase(
    path=[
        {
            "cookbook/agent_concepts/knowledge/filters/data/cv_1.txt": {
                "metadata": {
        ...
        {
            "cookbook/agent_concepts/knowledge/filters/data/cv_2.txt": {
                "metadata": {
        ...
        {
            "cookbook/agent_concepts/knowledge/filters/data/cv_3.txt": {
                "metadata": {
                    "user_id": "morgan_lee",
                    "document_type": "cv",
                    "year": 2025,
        ...
        {
            "cookbook/agent_concepts/knowledge/filters/data/cv_4.txt": {
                "metadata": {
        ...
        {
            "cookbook/agent_concepts/knowledge/filters/data/cv_5.txt": {
                "metadata": {
                    "user_id": "alex_rivera",
                    "document_type": "cv",
                    "year": 2025,
