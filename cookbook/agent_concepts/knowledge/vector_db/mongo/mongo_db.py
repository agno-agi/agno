...
"""
mdb_connection_string = "mongodb://mongoadmin:secret@localhost:27017/?authSource=admin"

knowledge_base = Knowledge(
    name="My MongoDB Knowledge Base",
    description="This is a knowledge base that uses a MongoDB Vector DB",
    vector_store=MongoDb(collection_name="recipes", db_url=mdb_connection_string),
)
