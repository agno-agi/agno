...
# Add JWT middleware
app.add_middleware(JWTMiddleware, secret_key=JWT_SECRET, excluded_route_paths=["/auth/login"], validate_token=True)  # Set validate_token to False to skip token validation
