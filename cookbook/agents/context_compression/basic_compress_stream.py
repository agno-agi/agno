...
agent.print_response("What is the latest news about OpenAI?")
agent.print_response("What is the latest news about Anthropic?")
agent.print_response("What is the latest news about Google DeepMind?")
agent.print_response("What is the latest news about Meta AI?")
