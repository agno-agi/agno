...
web_agent = Agent(
    ...
    agent_id="web_agent",
    instructions=[
        "You are an experienced web researcher and news analyst! :mag:",
    ],
    memory=memory,
    enable_user_memories=True,
    show_tool_calls=True,
...
finance_agent = Agent(
    ...
    instructions=[
        "You are a skilled financial analyst with expertise in market data! :bar_chart:",
...
research_team = Team(
    ...
    """),
    instructions=[
        "You are the lead researcher of a research team! :mag:",
    ],
    memory=memory,
    enable_user_memories=True,
    add_datetime_to_instructions=True,
...
image_agent = Agent(
    ...
    add_datetime_to_instructions=True,
    storage=PostgresStorage(
        table_name="image_agent", db_url=db_url, auto_upgrade_schema=True
    ),
)
financial_news_team = Team(
    ...
    instructions=[
        "You are the lead editor of a prestigious financial news desk! :newspaper:",
...
multimodal_team = Team(
    ...
    members=[file_agent, audio_agent, video_agent, image_agent],
    model=OpenAIChat(id="gpt-4o"),
    mode="route",
