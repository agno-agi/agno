...
```bash
python cookbook/data_labeling/audio_extraction/basic.py
python cookbook/data_labeling/audio_extraction/meeting_notes.py
python cookbook/data_labeling/audio_extraction/call_summary.py
```
