...
[`image_classification/`](../image_classification/) with multilabel.
...
```bash
python cookbook/data_labeling/image_bounding_boxes/basic.py
python cookbook/data_labeling/image_bounding_boxes/with_confidence.py
python cookbook/data_labeling/image_bounding_boxes/multi_object.py
```
