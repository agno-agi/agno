...
```bash
python cookbook/data_labeling/video_extraction/basic.py
python cookbook/data_labeling/video_extraction/scene_descriptions.py
python cookbook/data_labeling/video_extraction/action_timestamps.py
```
