...
The `cookbook/demo/` directory contains a comprehensive Agno v2.5 showcase: 6 agents, 2 teams, 2 workflows, and an eval suite. It demonstrates the full Agno stack — agents with knowledge + learning, teams in coordinate and route modes, workflows with parallel steps, and AgentOS serving everything via FastAPI.
...
sys.path.insert(0, str(Path(__file__).parent.parent.parent))  # Points to cookbook/demo/
