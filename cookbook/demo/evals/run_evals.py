...
Usage:
    .venvs/demo/bin/python -m cookbook.demo.evals.run_evals
    .venvs/demo/bin/python -m cookbook.demo.evals.run_evals --agent dash
    .venvs/demo/bin/python -m cookbook.demo.evals.run_evals --agent seek --verbose
    .venvs/demo/bin/python -m cookbook.demo.evals.run_evals --category dash_basic
"""
...
def get_component(agent_id: str):
    ...
    if agent_id == "dash":
        ...
        return dash
    elif agent_id == "reasoning-dash":
        from agents.dash import reasoning_dash

        return reasoning_dash
    elif agent_id == "scout":
        from agents.scout import scout

        return scout
    elif agent_id == "reasoning-scout":
        from agents.scout import reasoning_scout

        return reasoning_scout
    elif agent_id == "pal":
        ...
        return seek
    elif agent_id == "reasoning-seek":
        from agents.seek import reasoning_seek

        return reasoning_seek
    elif agent_id == "dex":
...
if __name__ == "__main__":
    ...
    run_evals(agent=args.agent, category=args.category, verbose=args.verbose)
