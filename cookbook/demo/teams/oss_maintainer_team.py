...
release_coordinator = Agent(
    ...
    instructions=[
        ...
        "  * list_pull_requests(repo_name, state='closed', base='main') - Get merged PRs",
        "  * get_pull_request(repo_name, pr_number) - Get PR details for changelog",
        "  * list_commits(repo_name, since_date) - Get commits since last release",
        "- Example: list_pull_requests('agno-agi/agno', state='closed', base='main')",
