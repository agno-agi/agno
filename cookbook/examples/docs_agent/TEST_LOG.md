...
**Result:** The live agent searched and read the bundled pages, explained filtered CSV export, distinguished a scheduled report link from a CSV attachment in a follow-up, and acknowledged the missing residency policy. Contract checks verified page discovery and rejected unlisted/traversal paths.
