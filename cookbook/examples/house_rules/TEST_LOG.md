...
**Description:** Before/after measurement of three routing rules: 4 tasks x k=4 attempts against an empty knowledge base, insert the rules, 4 x 4 again, then a fingerprint-checked diff. 32 live attempts per run. Run three times end to end to observe the variance.

**Result:** All three runs printed the same numbers, quoted:
