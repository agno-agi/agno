...
agno_os.environ["PHOENIX_CLIENT_HEADERS"] = (
    f"api_key={agno_os.getenv('ARIZE_PHOENIX_API_KEY')}"
)
agno_os.environ["PHOENIX_COLLECTOR_ENDPOINT"] = "https://app.phoenix.arize.com"
