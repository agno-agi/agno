...
class WorkflowWebSocketClient:
    ...
    def format_event(self, event_data: dict) -> Panel:
        ...
        # Additional details
        details = []
        important_fields = ['step_name', 'agent_name', 'run_id', 'session_id', 'step_index']
    ...
    def format_streaming_content(self, event_data: dict, emoji: str, color: str, timestamp: str) -> Optional[Panel]:
            ...
            async for message in self.websocket:
                ...
                try:
                    ...
                    if event_data:
                        ...
                        if len(message) < 100:
                            self.console.print(f"❌ [red]Could not parse message: {message[:50]}...[/red]")
    ...
    async def start_workflow(self, workflow_message: str, session_id: Optional[str] = None):
        ...
        self.console.print(f"🚀 [blue]Starting workflow with message:[/blue] [bold]{workflow_message}[/bold]")
                ...
                try:
                    ...
                    if user_input.lower() in ['quit', 'exit', 'q']:
                        ...
                        if workflow_message:
                            ...
                            self.console.print("❌ [red]Please provide a message for the workflow[/red]")
                    else:
                        self.console.print("❌ [red]Unknown command. Use 'start <message>', 'ping', or 'quit'[/red]")
    ...
    async def run_with_message(self, message: str):
        ...
        try:
            self.console.print("⏳ [yellow]Listening for workflow events... (Press Ctrl+C to stop)[/yellow]")
            await listen_task
        except KeyboardInterrupt:
