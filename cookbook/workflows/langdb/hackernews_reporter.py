...
class HackerNewsReporter(Workflow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Initialize agents with workflow reference
        self.hn_agent = Agent(
            model=LangDB(id="gpt-4o-mini", label="reporter"),
        ...
        self.writer = Agent(
            model=LangDB(id="gpt-4o-mini", label="writer"),
    ...
    def run(self, num_stories: int = 5) -> Iterator[RunResponse]:
        ...
        # Pass workflow instance to agents
        self.hn_agent.workflow = self
        self.writer.workflow = self
