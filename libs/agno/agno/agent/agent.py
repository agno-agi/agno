...
class Agent:
    ...
    def __init__(
        ...
        *,
        ...
        # Store original hooks for re-normalization across sync/async modes
        self._original_pre_hooks: Optional[List[Any]] = None
        self._original_model_hooks: Optional[List[Any]] = None
        self._original_post_hooks: Optional[List[Any]] = None
        self._hooks_normalised_mode: Optional[str] = None  # "sync" or "async"
