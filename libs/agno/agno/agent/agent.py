...
class Agent:
    ...
    # Fallback models to try specifically on rate-limit (429) errors
    rate_limit_fallbacks: Optional[List[Model]] = None
    # Fallback models to try specifically on context-window-exceeded errors
    context_window_fallbacks: Optional[List[Model]] = None
    # Agent name
    ...
    def __init__(
        ...
        *,
        ...
        self.fallback_models = fallback_models  # type: ignore[assignment]
        self.rate_limit_fallbacks = rate_limit_fallbacks  # type: ignore[assignment]
        self.context_window_fallbacks = context_window_fallbacks  # type: ignore[assignment]
        self.name = name
        self.id = id
