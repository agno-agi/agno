...
class Agent:
    ...
    def load_agent_session(self, session: AgentSession):
        ...
        # Get the id, user_id and session_id from the database
        if self.id is None and session.id is not None:
            self.id = session.id
    ...
    def load_session(self, force: bool = False) -> Optional[str]:
        ...
        if self.db is not None and self.team_id is None:
            ...
            if self.agent_session is None:
                ...
                # Initialize the id and session_id if they are not set
                if self.id is None:
        ...
        **kwargs: Any,
        ...
        if self.add_history_to_context and self.agent_session is not None:
            ...
            history: List[Message] = self.agent_session.get_messages_from_last_n_runs(
                ...
                # Only filter by id if this is part of a team
