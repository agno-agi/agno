...
class ContextCompactionManager:
    ...
    def _compact_tool_results(self, messages: List[Message], run_metrics: Optional["RunMetrics"]) -> None:
        ...
        from agno.compression._tool import compact_tools

        compact_tools(messages, model=self.model, run_metrics=run_metrics)
    ...
    async def _acompact_tool_results(self, messages: List[Message], run_metrics: Optional["RunMetrics"]) -> None:
        """Async compress large tool results."""
        from agno.compression._tool import acompact_tools

        await acompact_tools(messages, model=self.model, run_metrics=run_metrics)
