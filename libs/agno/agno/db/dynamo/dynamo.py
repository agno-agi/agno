...
class DynamoDb(BaseDb):
    ...
    def delete_session(self, session_id: Optional[str] = None, user_id: Optional[str] = None) -> bool:
        ...
        try:
            ...
            log_error(f"Failed to delete session {session_id}", exc_info=True)
            raise e
    ...
    def delete_sessions(self, session_ids: List[str], user_id: Optional[str] = None) -> None:
        ...
        try:
            ...
            log_error("Failed to delete sessions", exc_info=True)
            raise e
    ...
    def get_session(
        ...
        try:
            ...
            log_error(f"Failed to get session {session_id}", exc_info=True)
            raise e
    ...
    def get_sessions(
        ...
        try:
            ...
            log_error("Failed to get sessions", exc_info=True)
            raise e
    ...
    def rename_session(
        ...
        try:
            ...
            log_error(f"Failed to rename session {session_id}", exc_info=True)
            raise e
    ...
    def upsert_session(
        ...
        try:
            ...
            log_error(f"Failed to upsert session {session.session_id}", exc_info=True)
            raise e
    ...
    def delete_user_memory(self, memory_id: str, user_id: Optional[str] = None) -> None:
        ...
        try:
            ...
            log_error(f"Failed to delete user memory {memory_id}", exc_info=True)
            raise e
    ...
    def delete_user_memories(self, memory_ids: List[str], user_id: Optional[str] = None) -> None:
        ...
        try:
            ...
            log_error("Failed to delete user memories", exc_info=True)
            raise e
    ...
    def get_user_memory(
        ...
        try:
            ...
            log_error(f"Failed to get user memory {memory_id}", exc_info=True)
            raise e
    ...
    def get_user_memories(
        ...
        try:
            ...
            log_error("Failed to get user memories", exc_info=True)
            raise e
    ...
    def get_user_memory_stats(
        ...
        try:
            ...
            log_error("Failed to get user memory stats", exc_info=True)
            raise e
    ...
    def upsert_user_memory(
        ...
        try:
            ...
            log_error("Failed to upsert user memory", exc_info=True)
            raise e
    ...
    def calculate_metrics(self) -> Optional[Any]:
        ...
        try:
            ...
            log_error("Failed to calculate metrics", exc_info=True)
            raise e
    ...
    def _get_metrics_calculation_starting_date(self) -> Optional[date]:
        ...
        try:
            ...
            log_error("Failed to get metrics calculation starting date", exc_info=True)
            raise e
    ...
    def _get_all_sessions_for_metrics_calculation(
        ...
        try:
            ...
            log_error("Failed to get sessions for metrics calculation", exc_info=True)
            raise e
    ...
    def _upsert_single_metrics_record(self, table_name: str, record: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            log_error("Failed to upsert single metrics record", exc_info=True)
            raise e
    ...
    def _get_existing_metrics_record(self, table_name: str, date_str: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            log_error(f"Failed to get existing metrics record for date {date_str}", exc_info=True)
            raise e
    ...
    def _update_existing_metrics_record(
        ...
        try:
            ...
            log_error("Failed to update existing metrics record", exc_info=True)
            raise e
    ...
    def _create_new_metrics_record(self, table_name: str, record: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            log_error("Failed to create new metrics record", exc_info=True)
            raise e
    ...
    def get_metrics(
        ...
        try:
            ...
            log_error("Failed to get metrics", exc_info=True)
            raise e
    ...
    def delete_knowledge_content(self, id: str):
        ...
        try:
            ...
            log_error(f"Failed to delete knowledge content {id}", exc_info=True)
            raise e
    ...
    def get_knowledge_content(self, id: str) -> Optional[KnowledgeRow]:
        ...
        try:
            ...
            log_error(f"Failed to get knowledge content {id}", exc_info=True)
            raise e
        ...
        try:
            ...
            for item in items:
                try:
                    ...
                    log_error("Failed to deserialize knowledge row", exc_info=True)
            ...
            log_error("Failed to get knowledge contents", exc_info=True)
            raise e
    ...
    def upsert_knowledge_content(self, knowledge_row: KnowledgeRow):
        ...
        try:
            ...
            log_error(f"Failed to upsert knowledge content {knowledge_row.id}", exc_info=True)
            raise e
    ...
    def create_eval_run(self, eval_run: EvalRunRecord) -> Optional[EvalRunRecord]:
        ...
        try:
            ...
            log_error("Failed to create eval run", exc_info=True)
            raise e
    ...
    def delete_eval_runs(self, eval_run_ids: List[str]) -> None:
        ...
        try:
            ...
            log_error("Failed to delete eval runs", exc_info=True)
            raise e
    ...
    def get_eval_run_raw(self, eval_run_id: str, table: Optional[Any] = None) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            log_error(f"Failed to get eval run {eval_run_id}", exc_info=True)
            raise e
    ...
    def get_eval_runs(
        ...
        try:
            ...
            log_error("Failed to get eval runs", exc_info=True)
            raise e
    ...
    def rename_eval_run(
        ...
        try:
            ...
            log_error(f"Failed to rename eval run {eval_run_id}", exc_info=True)
            raise e
    ...
    def clear_cultural_knowledge(self) -> None:
        ...
        try:
            ...
            log_error("Failed to clear cultural knowledge", exc_info=True)
            raise e
    ...
    def delete_cultural_knowledge(self, id: str) -> None:
        ...
        try:
            ...
            log_error(f"Failed to delete cultural knowledge {id}", exc_info=True)
            raise e
    ...
    def get_cultural_knowledge(
        ...
        try:
            ...
            log_error(f"Failed to get cultural knowledge {id}", exc_info=True)
            raise e
    ...
    def get_all_cultural_knowledge(
        ...
        try:
            ...
            log_error("Failed to get all cultural knowledge", exc_info=True)
            raise e
    ...
    def upsert_cultural_knowledge(
        ...
        try:
            ...
            log_error("Failed to upsert cultural knowledge", exc_info=True)
            raise e
