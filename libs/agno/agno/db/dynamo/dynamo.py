...
class DynamoDb(BaseDb):
    ...
    def delete_session(self, session_id: Optional[str] = None, user_id: Optional[str] = None) -> bool:
        ...
        try:
            ...
            log_exception(f"Failed to delete session {session_id}")
            raise e
    ...
    def delete_sessions(self, session_ids: List[str], user_id: Optional[str] = None) -> None:
        ...
        try:
            ...
            log_exception("Failed to delete sessions")
            raise e
    ...
    def get_session(
        ...
        try:
            ...
            log_exception(f"Failed to get session {session_id}")
            raise e
    ...
    def get_sessions(
        ...
        try:
            ...
            log_exception("Failed to get sessions")
            raise e
    ...
    def rename_session(
        ...
        try:
            ...
            log_exception(f"Failed to rename session {session_id}")
            raise e
    ...
    def upsert_session(
        ...
        try:
            ...
            log_exception(f"Failed to upsert session {session.session_id}")
            raise e
    ...
    def delete_user_memory(self, memory_id: str, user_id: Optional[str] = None) -> None:
        ...
        try:
            ...
            log_exception(f"Failed to delete user memory {memory_id}")
            raise e
    ...
    def delete_user_memories(self, memory_ids: List[str], user_id: Optional[str] = None) -> None:
        ...
        try:
            ...
            log_exception("Failed to delete user memories")
            raise e
    ...
    def get_user_memory(
        ...
        try:
            ...
            log_exception(f"Failed to get user memory {memory_id}")
            raise e
    ...
    def get_user_memories(
        ...
        try:
            ...
            log_exception("Failed to get user memories")
            raise e
    ...
    def get_user_memory_stats(
        ...
        try:
            ...
            log_exception("Failed to get user memory stats")
            raise e
    ...
    def upsert_user_memory(
        ...
        try:
            ...
            log_exception("Failed to upsert user memory")
            raise e
    ...
    def calculate_metrics(self) -> Optional[Any]:
        ...
        try:
            ...
            log_exception("Failed to calculate metrics")
            raise e
    ...
    def _get_metrics_calculation_starting_date(self) -> Optional[date]:
        ...
        try:
            ...
            log_exception("Failed to get metrics calculation starting date")
            raise e
    ...
    def _get_all_sessions_for_metrics_calculation(
        ...
        try:
            ...
            log_exception("Failed to get sessions for metrics calculation")
            raise e
    ...
    def _upsert_single_metrics_record(self, table_name: str, record: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            log_exception("Failed to upsert single metrics record")
            raise e
    ...
    def _get_existing_metrics_record(self, table_name: str, date_str: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            log_exception(f"Failed to get existing metrics record for date {date_str}")
            raise e
    ...
    def _update_existing_metrics_record(
        ...
        try:
            ...
            log_exception("Failed to update existing metrics record")
            raise e
    ...
    def _create_new_metrics_record(self, table_name: str, record: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            log_exception("Failed to create new metrics record")
            raise e
    ...
    def get_metrics(
        ...
        try:
            ...
            log_exception("Failed to get metrics")
            raise e
    ...
    def delete_knowledge_content(self, id: str):
        ...
        try:
            ...
            log_exception(f"Failed to delete knowledge content {id}")
            raise e
    ...
    def get_knowledge_content(self, id: str) -> Optional[KnowledgeRow]:
        ...
        try:
            ...
            log_exception(f"Failed to get knowledge content {id}")
            raise e
        ...
        try:
            ...
            for item in items:
                try:
                    ...
                    log_exception("Failed to deserialize knowledge row")
            ...
            log_exception("Failed to get knowledge contents")
            raise e
    ...
    def upsert_knowledge_content(self, knowledge_row: KnowledgeRow):
        ...
        try:
            ...
            log_exception(f"Failed to upsert knowledge content {knowledge_row.id}")
            raise e
    ...
    def create_eval_run(self, eval_run: EvalRunRecord) -> Optional[EvalRunRecord]:
        ...
        try:
            ...
            log_exception("Failed to create eval run")
            raise e
    ...
    def delete_eval_runs(self, eval_run_ids: List[str]) -> None:
        ...
        try:
            ...
            log_exception("Failed to delete eval runs")
            raise e
    ...
    def get_eval_run_raw(self, eval_run_id: str, table: Optional[Any] = None) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            log_exception(f"Failed to get eval run {eval_run_id}")
            raise e
    ...
    def get_eval_runs(
        ...
        try:
            ...
            log_exception("Failed to get eval runs")
            raise e
    ...
    def rename_eval_run(
        ...
        try:
            ...
            log_exception(f"Failed to rename eval run {eval_run_id}")
            raise e
    ...
    def clear_cultural_knowledge(self) -> None:
        ...
        try:
            ...
            log_exception("Failed to clear cultural knowledge")
            raise e
    ...
    def delete_cultural_knowledge(self, id: str) -> None:
        ...
        try:
            ...
            log_exception(f"Failed to delete cultural knowledge {id}")
            raise e
    ...
    def get_cultural_knowledge(
        ...
        try:
            ...
            log_exception(f"Failed to get cultural knowledge {id}")
            raise e
    ...
    def get_all_cultural_knowledge(
        ...
        try:
            ...
            log_exception("Failed to get all cultural knowledge")
            raise e
    ...
    def upsert_cultural_knowledge(
        ...
        try:
            ...
            log_exception("Failed to upsert cultural knowledge")
            raise e
