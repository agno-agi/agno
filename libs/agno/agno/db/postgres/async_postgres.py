...
class AsyncPostgresDb(AsyncBaseDb):
    ...
    async def clear_cultural_knowledge(self) -> None:
        ...
        try:
            ...
            log_error("Exception deleting all cultural knowledge", exc_info=True)
    ...
    async def delete_cultural_knowledge(self, id: str) -> None:
        ...
        try:
            ...
            log_error("Exception deleting cultural knowledge", exc_info=True)
    ...
    async def get_cultural_knowledge(
        ...
        try:
            ...
            log_error("Exception reading cultural knowledge", exc_info=True)
            return None
    ...
    async def get_all_cultural_knowledge(
        ...
        try:
            ...
            log_error("Exception reading all cultural knowledge", exc_info=True)
            return [] if deserialize else ([], 0)
