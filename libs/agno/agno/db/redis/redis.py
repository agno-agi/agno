...
class RedisDb(BaseDb):
    ...
    def _store_record(
        ...
        try:
            ...
            log_error("Error storing Redis record")
            return False
    ...
    def _get_record(self, table_type: str, record_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            log_error(f"Error getting record {record_id}")
            return None
    ...
    def _delete_record(self, table_type: str, record_id: str, index_fields: Optional[List[str]] = None) -> bool:
        ...
        try:
            ...
            log_error(f"Error deleting record {record_id}")
            return False
    ...
    def _get_all_records(self, table_type: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            log_error(f"Error getting all records for {table_type}")
            return []
    ...
    def rename_eval_run(
        ...
        try:
            ...
            log_error(f"Error updating eval run name {eval_run_id}")
            raise
