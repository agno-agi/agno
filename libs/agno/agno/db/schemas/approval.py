...
@dataclass
class Approval:
    """Model for a human approval request.

    Created when a run pauses for HITL with a tool that has requires_approval=True.
    Acts as a denormalized index for the Approvals inbox.
    """
