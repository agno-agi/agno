...
class BaseGuardrail(ABC):
    ...
    All hook methods have default no-op implementations so subclasses only
    need to override the hooks they care about. A guardrail that only
    validates input can implement pre_check() alone without stubbing out
    model_check() and post_check().
    """
    ...
    def check(self, run_input: Union[RunInput, TeamRunInput]) -> None:
        ...
        log_debug("check() is deprecated and will be removed in a future version. Use pre_check() instead.")
        return self.pre_check(run_input)

    async def async_check(self, run_input: Union[RunInput, TeamRunInput]) -> None:
        """Deprecated. Use async_pre_check() instead."""
        log_debug("async_check() is deprecated and will be removed in a future version. Use async_pre_check() instead.")
