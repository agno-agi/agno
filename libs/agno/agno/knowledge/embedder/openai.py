...
class OpenAIEmbedder(Embedder):
    ...
    def get_embedding_and_usage(self, text: str) -> Tuple[List[float], Optional[Dict]]:
        try:
            ...
            log_warning(f"Failed to get embedding and usage: {e}", exc_info=True)
            return [], None
    ...
    async def async_get_embedding(self, text: str) -> List[float]:
        ...
        try:
            ...
            log_warning(f"Failed to get async embedding: {e}", exc_info=True)
            return []
    ...
    async def async_get_embedding_and_usage(self, text: str):
        ...
        try:
            ...
            log_warning(f"Error getting embedding: {e}", exc_info=True)
            return [], None
