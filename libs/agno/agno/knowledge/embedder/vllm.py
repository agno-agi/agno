...
class VLLMEmbedder(Embedder):
    ...
    def _create_embedding_local(self, text: str) -> Optional[EmbeddingRequestOutput]:
        ...
        try:
            ...
            log_warning(f"Error creating local embedding: {e}")
            return None
    ...
    def get_embedding(self, text: str) -> List[float]:
        try:
            ...
            log_warning(f"Error extracting embedding: {e}")
            return []
    ...
    def get_embedding_and_usage(self, text: str) -> Tuple[List[float], Optional[Dict]]:
        if self.is_remote:
            try:
                ...
                log_warning(f"Error in remote embedding: {e}")
                return [], None
        else:
    ...
    async def async_get_embedding(self, text: str) -> List[float]:
        ...
        if self.is_remote:
            ...
            try:
                ...
                log_warning(f"Error in async remote embedding: {e}")
                return []
        else:
    ...
    async def async_get_embedding_and_usage(self, text: str) -> Tuple[List[float], Optional[Dict]]:
        ...
        if self.is_remote:
            ...
            try:
                ...
                log_warning(f"Error in async local embedding: {e}")
                return [], None
