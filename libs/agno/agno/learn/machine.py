        ...
        **kwargs,
        ...
        for name, store in self.stores.items():
            try:
                ...
                log_warning(f"Error getting tools from {name}: {e}", exc_info=True)
        ...
        **kwargs,
        ...
        for name, store in self.stores.items():
            try:
                ...
                log_warning(f"Error processing through {name}: {e}", exc_info=True)
        ...
        **kwargs,
        ...
        for name, store in self.stores.items():
            try:
                ...
                log_warning(f"Error recalling from {name}: {e}", exc_info=True)
        ...
        for name, data in results.items():
            ...
            if store:
                try:
                    ...
                    log_warning(f"Error building context from {name}: {e}", exc_info=True)
