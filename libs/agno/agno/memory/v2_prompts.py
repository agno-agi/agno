...
These constants define the default prompts used for memory extraction and agentic memory tools.
They can be overridden by passing custom prompts to MemoryManagerV2 constructor.
"""

from textwrap import dedent

# =============================================================================
# EXTRACTION SYSTEM MESSAGE COMPONENTS
# =============================================================================

DEFAULT_EXTRACTION_INTRO = dedent("""\
...
DEFAULT_EXTRACTION_TOOL_USAGE = dedent("""\
...
# =============================================================================
# PER-LAYER EXTRACTION PROMPTS
# =============================================================================

DEFAULT_PROFILE_PROMPT = dedent("""\
...
DEFAULT_POLICIES_PROMPT = dedent("""\
...
DEFAULT_KNOWLEDGE_PROMPT = dedent("""\
...
DEFAULT_FEEDBACK_PROMPT = dedent("""\
...
DEFAULT_DECISION_FRAMEWORK = dedent("""\
    ## Decision Framework
...
DEFAULT_AGENTIC_INSTRUCTIONS = dedent("""\
