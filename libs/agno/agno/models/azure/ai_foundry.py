...
class AzureAIFoundry(Model):
    ...
    def invoke(
        ...
        try:
            ...
            log_error("Azure AI API error", exc_info=True)
            ...
            log_error("Error from Azure AI API", exc_info=True)
    ...
    def _parse_provider_response(self, response: ChatCompletions, **kwargs) -> ModelResponse:
        ...
        try:
            ...
            log_error("Error parsing Azure AI response", exc_info=True)
            raise ModelProviderError(message=str(e), model_name=self.name, model_id=self.id) from e
    ...
    def _parse_provider_response_delta(self, response_delta: StreamingChatCompletionsUpdate) -> ModelResponse:
        ...
        try:
            ...
            log_error("Error parsing Azure AI response delta", exc_info=True)
            raise ModelProviderError(message=str(e), model_name=self.name, model_id=self.id) from e
