...
class Model(ABC):
            ...
            if assistant_message.tool_calls:
                ...
                for function_call_response in self.run_function_calls(
                    ...
                    if isinstance(function_call_response, ModelResponse):
                        ...
                        if function_call_response.generated_images is not None:
                            if model_response.generated_images is None:
                                model_response.generated_images = []
                            model_response.generated_images.extend(function_call_response.generated_images)
    ...
    def run_function_call(
        ...
        yield ModelResponse(
            ...
            generated_images=function_execution_result.images,
            generated_videos=function_execution_result.videos,
            generated_audio=function_execution_result.audio,
        )
