...
class Gemini(Model):
    ...
    def invoke(
        ...
        try:
            ...
            log_error("Error from Gemini API", exc_info=True)
            error_message = str(e)
            ...
            log_error("Unknown error from Gemini API", exc_info=True)
    ...
    def create_file_search_store(self, display_name: Optional[str] = None) -> Any:
        ...
        try:
            ...
            log_error("Error creating File Search store", exc_info=True)
            raise
    ...
    def list_file_search_stores(self, page_size: int = 100) -> List[Any]:
        ...
        try:
            ...
            log_error("Error listing File Search stores", exc_info=True)
            raise
    ...
    def get_file_search_store(self, name: str) -> Any:
        ...
        try:
            ...
            log_error(f"Error getting File Search store {name}", exc_info=True)
            raise
    ...
    def delete_file_search_store(self, name: str, force: bool = False) -> None:
        ...
        try:
            ...
            log_error(f"Error deleting File Search store {name}", exc_info=True)
            raise
    ...
    def upload_to_file_search_store(
        ...
        try:
            ...
            log_error("Error uploading file to File Search store", exc_info=True)
            raise
    ...
    def import_file_to_store(
        ...
        try:
            ...
            log_error("Error importing file to File Search store", exc_info=True)
            raise
    ...
    def list_documents(self, store_name: str, page_size: int = 20) -> List[Any]:
        ...
        try:
            ...
            log_error(f"Error listing documents in store {store_name}", exc_info=True)
            raise
    ...
    def get_document(self, document_name: str) -> Any:
        ...
        try:
            ...
            log_error(f"Error getting document {document_name}", exc_info=True)
            raise
    ...
    def delete_document(self, document_name: str) -> None:
        ...
        try:
            ...
            log_error(f"Error deleting document {document_name}", exc_info=True)
            raise
