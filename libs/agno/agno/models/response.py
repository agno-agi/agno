...
class ModelResponse:
    ...
    # Media artifacts generated by function calls
    generated_images: Optional[List[ImageArtifact]] = None
    generated_videos: Optional[List[VideoArtifact]] = None
    generated_audio: Optional[List[AudioArtifact]] = None
