...
from agno.os.routers.agents import get_agents_router
...
from agno.os.routers.teams import get_teams_router
from agno.os.routers.workflows import get_workflows_router
...
class AgentOS:
    ...
    def _add_built_in_routes(self, app: FastAPI) -> None:
        ...
        self._add_router(app, get_agents_router(self, settings=self.settings))
        self._add_router(app, get_teams_router(self, settings=self.settings))
        self._add_router(app, get_workflows_router(self, settings=self.settings))
