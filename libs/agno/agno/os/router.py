...
def get_base_router(
    ...
    async def config() -> ConfigResponse:
        return ConfigResponse(
            ...
            memory=os.config.memory if os.config and os.config.memory else os._get_default_memory_config(),
            knowledge=os.config.knowledge if os.config and os.config.knowledge else os._get_default_knowledge_config(),
            evals=os.config.evals if os.config and os.config.evals else os._get_default_evals_config(),
