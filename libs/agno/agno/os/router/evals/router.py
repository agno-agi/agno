...
from agno.os.router.evals.utils import (
    run_accuracy_eval,
...
def attach_routes(
    ...
    async def get_eval_runs(
        ...
        return PaginatedResponse(
            data=[EvalRunResponse.from_dict(eval_run) for eval_run in eval_runs],  # type: ignore
            meta=PaginationInfo(
                page=page,
                limit=limit,
    ...
    async def get_eval_run(
        ...
        return EvalRunResponse.from_dict(eval_run)  # type: ignore
