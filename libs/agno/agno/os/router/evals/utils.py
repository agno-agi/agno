...
from agno.os.router.evals.schema import EvalRunRequest, EvalRunResponse
from agno.team import RemoteTeam, Team


async def run_accuracy_eval(
    eval_run_input: EvalRunRequest,
    ...
    eval_run = EvalRunResponse.from_accuracy_eval(accuracy_eval=accuracy_eval, result=result)
...
async def run_agent_as_judge_eval(
    ...
    eval_run = EvalRunResponse.from_agent_as_judge_eval(
...
async def run_performance_eval(
    ...
    eval_run = EvalRunResponse.from_performance_eval(
...
async def run_reliability_eval(
    ...
    eval_run = EvalRunResponse.from_reliability_eval(
