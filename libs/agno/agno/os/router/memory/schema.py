...
class UserMemoryResponse(BaseModel):
    ...
    @classmethod
    def from_dict(cls, memory_dict: Dict[str, Any]) -> Optional["UserMemoryResponse"]:
...
class UserStatsResponse(BaseModel):
    ...
    @classmethod
    def from_dict(cls, user_stats_dict: Dict[str, Any]) -> "UserStatsResponse":
...
class OptimizeMemoriesResponse(BaseModel):
    ...
    memories: List[UserMemoryResponse] = Field(..., description="List of optimized memory objects")
