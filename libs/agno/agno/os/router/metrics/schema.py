...
class DayAggregatedMetricsResponse(BaseModel):
    ...
    @classmethod
    def from_dict(cls, metrics_dict: Dict[str, Any]) -> "DayAggregatedMetricsResponse":
...
class MetricsResponse(BaseModel):
    metrics: List[DayAggregatedMetricsResponse] = Field(..., description="List of daily aggregated metrics")
