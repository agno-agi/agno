...
def attach_routes(router: APIRouter, dbs: dict[str, list[Union[BaseDb, AsyncBaseDb, RemoteDb]]]) -> APIRouter:
    ...
    async def create_session(
        ...
        try:
            ...
            return SessionResponse.from_session(created_session)  # type: ignore
        except Exception as e:
    ...
    async def get_session_by_id(
        ...
        return SessionResponse.from_session(session)  # type: ignore
    ...
    async def get_session_runs(
        ...
        return [RunResponse.from_dict(run) for run in filtered_runs]
    ...
    async def get_session_run(
        ...
        return RunResponse.from_dict(target_run)
    ...
    async def update_session(
        ...
        return SessionResponse.from_session(updated_session)  # type: ignore
