...
def get_workflow_router(
    ...
    @router.post(
        ...
        response_model=RunCancelledResponse,
        description=(
        ...
        responses={
            200: {"description": "Workflow run cancelled successfully", "model": RunCancelledResponse},
    ...
    async def cancel_workflow_run(workflow_id: str, run_id: str):
        ...
        return RunCancelledResponse(id=run_id, success=cancelled).model_dump(exclude_none=True)
