...
def attach_routes(
    ...
    async def list_components(
        ...
        try:
            ...
            if needs_filtering:
                # Fetch all components (unpaginated) so we can filter before applying pagination.
                # This is necessary because registry-shadowed items can appear at any offset.
