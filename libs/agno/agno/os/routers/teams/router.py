            ...
            for file in files:
                if file.content_type in [
                    ...
                    try:
                        ...
                        logger.error(f"Error processing image {file.filename}", exc_info=True)
                        continue
                    ...
                    try:
                        ...
                        logger.error(f"Error processing audio {file.filename}", exc_info=True)
                        continue
                    ...
                    try:
                        ...
                        logger.error(f"Error processing video {file.filename}", exc_info=True)
                        continue
                elif file.content_type in [
                    "application/pdf",
                    "text/csv",
