...
def attach_routes(router: APIRouter, dbs: dict[str, list[Union[BaseDb, AsyncBaseDb, RemoteDb]]]) -> APIRouter:
    ...
    async def get_traces(
        ...
        try:
            ...
            log_error("Error retrieving traces", exc_info=True)
    ...
    async def get_trace(
        ...
        try:
            ...
            log_error(f"Error retrieving trace {trace_id}", exc_info=True)
    ...
    async def get_trace_stats(
        ...
        try:
            ...
            log_error("Error retrieving trace statistics", exc_info=True)
    ...
    async def search_traces(
        ...
        try:
            ...
            log_error("Error searching traces", exc_info=True)
