...
def _get_mode_instructions(team: "Team") -> str:
    ...
    if team.mode == TeamMode.tasks:
        content += (
            "You operate in autonomous task mode.\n\n"
            "For straightforward requests you can handle directly — simple greetings, general conversation, "
            "or requests that don't need member expertise — respond without creating tasks or delegating.\n\n"
            "For complex goals that require member work:\n\n"
            "Planning:\n"
            ...
            "- Only create tasks for work that genuinely requires delegation to a member. "
            "Do not over-decompose simple goals into unnecessary subtasks.\n"
            ...
            "- Use `execute_tasks_parallel` only for groups of genuinely independent, "
            "substantial tasks where parallelism improves throughput.\n"
            ...
            "If you responded directly without creating tasks, do not call it.\n"
