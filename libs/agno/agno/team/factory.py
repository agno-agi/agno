"""Team factories for per-request, context-driven team construction."""
...
class TeamFactory:
    """A registered callable that produces a Team per request.
    ...
    Args:
        id: Stable handle used in API URLs (e.g. ``POST /teams/{id}/runs``).
        factory: Callable that receives a RequestContext and returns a Team.
