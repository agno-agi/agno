...
#     response2 = agent.run(
#         input="Generate an image of a cute cat, then count how many total images are available and analyze all of them."
#     )
...
#     response3 = agent.run(
#         input="Count how many images are available from all previous runs and analyze them. This should include both the original uploaded image and any generated images."
#     )
    
#     print(f"Run 3 Response: {response3.content}")
#     print(f"Run 3 Images in response: {len(response3.images or [])}")
#     print("\n" + "="*50 + "\n")

#     # Test 4: New session with fresh image
#     print("4. Testing new image in same session...")
    
#     new_sample_image = Image(content=b"ANOTHER_FAKE_IMAGE_FOR_DEMO")
    
#     response4 = agent.run(
#         input="I'm uploading another image. Count total images available (should include history + new image) and analyze them.",
#         images=[new_sample_image]
#     )
    
#     print(f"Run 4 Response: {response4.content}")
#     print(f"Run 4 Images in response: {len(response4.images or [])}")
    
#     # Summary
#     print("\n" + "="*50)
#     print("TEST SUMMARY:")
#     print(f"- Run 1: Should find 1 image (uploaded)")
#     print(f"- Run 2: Should find 2 images (uploaded + generated)")  
#     print(f"- Run 3: Should find 2 images (from history)")
#     print(f"- Run 4: Should find 3 images (history + new upload)")
#     print("="*50)
