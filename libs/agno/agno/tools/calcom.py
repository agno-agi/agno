...
class CalComTools(Toolkit):
    ...
    def get_available_slots(
        ...
        try:
            ...
            logger.error("Error fetching available slots", exc_info=True)
    ...
    def create_booking(
        ...
        try:
            ...
            logger.error("Error creating booking", exc_info=True)
            return f"Error: {str(e)}"
    ...
    def get_upcoming_bookings(self, email: Optional[str] = None) -> str:
        ...
        try:
            ...
            logger.error("Error fetching upcoming bookings", exc_info=True)
            return f"Error: {str(e)}"
    ...
    def reschedule_booking(
        ...
        try:
            ...
            logger.error("Error rescheduling booking", exc_info=True)
            return f"Error: {str(e)}"
    ...
    def cancel_booking(self, booking_uid: str, reason: str) -> str:
        ...
        try:
            ...
            logger.error("Error cancelling booking", exc_info=True)
            return f"Error: {str(e)}"
