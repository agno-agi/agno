...
def tool(*args, **kwargs) -> Union[Function, Callable[[F], Function]]:
    ...
    Args:
        ...
        requires_approval: Optional[bool] - If True, an approval record is created when this tool pauses a run. Implies requires_confirmation=True when no other HITL flag is set.
