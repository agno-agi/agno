...
class DuckDbTools(Toolkit):
    ...
    def __init__(
        ...
        run_query: bool = True,
        create_table_from_path: bool = True,
        summarize_table: bool = True,
        export_table_to_path: bool = True,
        load_local_path_to_table: bool = True,
        load_local_csv_to_table: bool = True,
        load_s3_path_to_table: bool = True,
        load_s3_csv_to_table: bool = True,
