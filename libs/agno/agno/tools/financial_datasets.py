...
class FinancialDatasetsTools(Toolkit):
    def __init__(
        ...
        if not self.api_key:
            log_error("FINANCIAL_DATASETS_API_KEY not set. Please set the FINANCIAL_DATASETS_API_KEY environment variable.")
    ...
    def get_income_statements(self, ticker: str, period: str = "annual", limit: int = 10) -> Dict[str, Any]:
        """
    ...
    def get_balance_sheets(self, ticker: str, period: str = "annual", limit: int = 10) -> Dict[str, Any]:
        """
    ...
    def get_cash_flow_statements(self, ticker: str, period: str = "annual", limit: int = 10) -> Dict[str, Any]:
        """
    ...
    def get_crypto_prices(self, symbol: str, interval: str = "1d", limit: int = 100) -> Dict[str, Any]:
        """
    ...
    def get_earnings(self, ticker: str, limit: int = 10) -> Dict[str, Any]:
        """
    ...
    def get_insider_trades(self, ticker: str, limit: int = 50) -> Dict[str, Any]:
        """
    ...
    def get_news(self, ticker: str = None, limit: int = 50) -> Dict[str, Any]:
        """
    ...
    def get_stock_prices(self, ticker: str, interval: str = "1d", limit: int = 100) -> Dict[str, Any]:
        """
    ...
    def get_sec_filings(self, ticker: str, form_type: str = None, limit: int = 50) -> Dict[str, Any]:
        """
    ...
    def get_segmented_financials(self, ticker: str, period: str = "annual", limit: int = 10) -> Dict[str, Any]:
        """
