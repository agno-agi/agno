...
class Mem0Tools(Toolkit):
    def __init__(
        ...
        **kwargs,
        ...
        try:
            ...
            log_error("Failed to initialize Mem0 client", exc_info=True)
    ...
    def add_memory(
        ...
        try:
            ...
            log_error("Error adding memory", exc_info=True)
    ...
    def search_memory(
        ...
        try:
            ...
            log_error("Error searching memory", exc_info=True)
    ...
    def get_all_memories(self, run_context: RunContext) -> str:
        ...
        try:
            ...
            log_error("Error getting all memories", exc_info=True)
    ...
    def delete_all_memories(self, run_context: RunContext) -> str:
        ...
        try:
            ...
            log_error("Error deleting all memories", exc_info=True)
