...
class MemoryTools(Toolkit):
    ...
    def think(self, run_context: RunContext, thought: str) -> str:
        ...
        try:
            ...
            log_error("Error recording memory thought", exc_info=True)
    ...
    def get_memories(self, run_context: RunContext) -> str:
        ...
        try:
            ...
            log_error("Error getting memories", exc_info=True)
    ...
    def update_memory(
        ...
        try:
            ...
            log_error("Error updating memory", exc_info=True)
    ...
    def analyze(self, run_context: RunContext, analysis: str) -> str:
        ...
        try:
            ...
            log_error("Error recording memory analysis", exc_info=True)
