...
class Neo4jTools(Toolkit):
    ...
    def list_labels(self) -> list:
        ...
        try:
            ...
            logger.error("Error listing labels", exc_info=True)
            return []
    ...
    def list_relationship_types(self) -> list:
        ...
        try:
            ...
            logger.error("Error listing relationship types", exc_info=True)
            return []
    ...
    def get_schema(self) -> list:
        ...
        try:
            ...
            logger.error("Error getting Neo4j schema", exc_info=True)
            return []
    ...
    def run_cypher_query(self, query: str) -> list:
        ...
        try:
            ...
            logger.error("Error running Cypher query", exc_info=True)
            return []
