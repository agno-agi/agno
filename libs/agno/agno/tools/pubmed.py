...
class PubmedTools(Toolkit):
    ...
    def search_pubmed(self, query: str, max_results: Optional[int] = None) -> str:
        ...
        try:
            ...
            # `or` would replace an explicit 0 (retmax=0 is valid PubMed input) with the fallbacks.
            max_results = max_results if max_results is not None else (self.max_results or 10)
