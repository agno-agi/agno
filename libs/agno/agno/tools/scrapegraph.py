    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            crawl_poll_interval (int): Seconds between crawl status polls. Defaults to 3.
            crawl_max_wait (int): Max seconds to wait for a crawl to complete. Defaults to 180.
