...
class ShellTools(Toolkit):
    ...
    def run_shell_command(self, args: List[str], tail: int = 100, timeout: Optional[int] = None) -> str:
        ...
        try:
            ...
            log_warning(f"Failed to run shell command: {e}")
            return json.dumps(
                {
                    "success": False,
                    "error": str(e),
    ...
    def change_directory(self, path: str) -> str:
        ...
        try:
            ...
            log_warning(f"Failed to change directory: {e}")
            return json.dumps(
                {
                    "success": False,
                    "error": str(e),
    ...
    def list_files(self, path: Optional[str] = None, pattern: str = "*") -> str:
        ...
        try:
            ...
            log_warning(f"Failed to list files: {e}")
            return json.dumps(
                {
                    "success": False,
                    "error": str(e),
    ...
    def get_os_info(self) -> str:
        ...
        try:
            ...
            log_warning(f"Failed to get OS info: {e}")
            return json.dumps(
                {
                    "success": False,
                    "error": str(e),
