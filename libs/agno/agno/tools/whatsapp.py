...
class WhatsAppTools(Toolkit):
    ...
    def send_text_message(
        ...
        try:
            ...
            logger.error("Error sending text message", exc_info=True)
            raise
    ...
    def send_template_message(
        ...
        try:
            ...
            logger.error("Error sending template message", exc_info=True)
            raise
    ...
    def send_reply_buttons(
        ...
        try:
            ...
            logger.error("Error sending reply buttons", exc_info=True)
            raise
    ...
    def send_list_message(
        ...
        try:
            ...
            logger.error("Error sending list message", exc_info=True)
            raise
    ...
    def send_image(
        ...
        try:
            ...
            logger.error("Error sending image", exc_info=True)
            raise
    ...
    def send_document(
        ...
        try:
            ...
            logger.error("Error sending document", exc_info=True)
            raise
    ...
    def send_location(
        ...
        try:
            ...
            logger.error("Error sending location", exc_info=True)
            raise
    ...
    def send_reaction(
        ...
        try:
            ...
            logger.error("Error sending reaction", exc_info=True)
            raise
