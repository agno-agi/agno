...
class WorkflowTools(Toolkit):
    ...
    def think(self, run_context: RunContext, thought: str) -> str:
        ...
        try:
            ...
            log_error("Error recording workflow thought", exc_info=True)
    ...
    def run_workflow(
        ...
        try:
            ...
            log_error("Error running workflow", exc_info=True)
    ...
    def analyze(self, run_context: RunContext, analysis: str) -> str:
        ...
        try:
            ...
            log_error("Error recording workflow analysis", exc_info=True)
