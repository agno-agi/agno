...
class XTools(Toolkit):
    ...
    def reply_to_post(self, post_id: str, text: str) -> str:
        ...
        try:
            ...
            logger.error("Error replying to post", exc_info=True)
            return json.dumps({"error": str(e)})
    ...
    def send_dm(self, recipient: str, text: str) -> str:
        ...
        try:
            ...
            logger.error("Error from X while sending DM", exc_info=True)
            error_message = str(e)
            ...
            logger.error("Unexpected error sending DM", exc_info=True)
    ...
    def get_home_timeline(self, max_results: int = 10) -> str:
        ...
        try:
            ...
            logger.error("Error fetching home timeline", exc_info=True)
            return json.dumps({"error": str(e)})
    ...
    def search_posts(self, query: str, max_results: int = 10) -> str:
        ...
        try:
            ...
            logger.error("Error searching posts", exc_info=True)
            return json.dumps({"error": str(e), "query": query})
        except Exception as e:
            logger.error("Unexpected error searching posts", exc_info=True)
