...
DEFAULT_INSTRUCTIONS = dedent(
    ...
    - Use `get_zep_memory` tool to get the memory for the current Zep session for additional context. This will give you the entire context of the user's memories with relevant facts.
...
class ZepTools(Toolkit):
    ...
    Args:
        ...
        add_message: Enable add_zep_message tool. Defaults to False (writes to memory).
        get_memory: Enable get_zep_memory tool. Defaults to True.
        search_memory: Enable search_zep_memory tool. Defaults to True.
    ...
    def search_zep_memory(self, query: str, scope: str = "edges", limit: int = 5) -> str:
