...
class LightRag(VectorDb):
    ...
    async def async_search(
        ...
        try:
            ...
            log_error("HTTP Request Error", exc_info=True)
            return []
        except httpx.HTTPStatusError:
            log_error("HTTP Status Error", exc_info=True)
            return []
        except Exception:
            log_error("Unexpected error during LightRAG server search", exc_info=True)
            return None
    ...
    def delete_by_external_id(self, external_id: str) -> bool:
        ...
        try:
            ...
            log_error("Error in sync delete_by_external_id", exc_info=True)
            return False
    ...
    async def async_delete_by_external_id(self, external_id: str) -> bool:
        ...
        try:
            ...
            log_error(f"Error deleting document {external_id}", exc_info=True)
            return False
