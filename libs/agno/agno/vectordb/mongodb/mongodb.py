...
class MongoDb(VectorDb):
        ...
        if self._client is None:
            if self.cosmos_compatibility:
                try:
                    ...
                    logger.error("An error occurred while connecting to Azure Cosmos DB", exc_info=True)
                    raise
            else:
                try:
                    ...
                    logger.error("An error occurred while connecting to MongoDB", exc_info=True)
                    raise
        return self._client
    ...
    async def _get_async_client(self) -> AsyncMongoClient:
        ...
        if self._async_client is None:
            ...
            try:
                ...
                logger.error("Failed to connect to MongoDB asynchronously", exc_info=True)
                raise
    ...
    def _create_search_index(self, overwrite: bool = True) -> None:
        ...
        if self.cosmos_compatibility:
            try:
                ...
                logger.error("Error creating vector search index", exc_info=True)
                raise
        else:
            for attempt in range(max_retries):
                try:
                    ...
                    if "Duplicate Index" in str(e) and attempt < max_retries - 1:
                        ...
                        continue
                    logger.error("Failed to create search index", exc_info=True)
                    raise
                except Exception:
                    logger.error("Unexpected error creating search index", exc_info=True)
                    raise
    ...
    def _search_index_exists(self) -> bool:
        ...
        if self.cosmos_compatibility:
            ...
            try:
                ...
                logger.error("Error checking search index existence", exc_info=True)
                return False
        else:
            try:
                collection = self._get_collection()
    ...
    async def _wait_for_index_ready_async(self) -> None:
        ...
        while True:
            try:
                ...
                logger.error("Error checking index status asynchronously", exc_info=True)
    ...
    def id_exists(self, id: str) -> bool:
        ...
        try:
            ...
            logger.error("Error checking document ID existence", exc_info=True)
            return False
    ...
    def content_hash_exists(self, content_hash: str) -> bool:
        ...
        try:
            ...
            logger.error("Error checking content_hash existence", exc_info=True)
            return False
    ...
    def insert(self, content_hash: str, documents: List[Document], filters: Optional[Dict[str, Any]] = None) -> None:
        ...
        if prepared_docs:
            try:
                ...
                logger.error("Error inserting documents", exc_info=True)
    ...
    def upsert(self, content_hash: str, documents: List[Document], filters: Optional[Dict[str, Any]] = None) -> None:
        ...
        for document in documents:
            try:
                ...
                logger.error(f"Error upserting document '{document.name}'", exc_info=True)
    ...
    def search(
        ...
        if self.cosmos_compatibility:
            ...
            try:
                ...
                logger.error("Error during vector search", exc_info=True)
                return []
        else:
    ...
    def keyword_search(self, query: str, limit: int = 5) -> List[Document]:
        ...
        try:
            ...
            logger.error("Error during keyword search", exc_info=True)
            return []
    ...
    def hybrid_search(
        ...
        try:
            ...
            logger.error("Error during hybrid search", exc_info=True)
            import traceback
                ...
                try:
                    ...
                    if self._search_index_exists():
                        ...
                        try:
                            ...
                            logger.error("Error dropping index", exc_info=True)
    ...
    async def async_insert(
        ...
        if prepared_docs:
            try:
                ...
                logger.error("Error inserting documents asynchronously", exc_info=True)
    ...
    async def async_upsert(
        ...
        for document in documents:
            try:
                ...
                logger.error(f"Error upserting document '{document.name}' asynchronously", exc_info=True)
    ...
    async def async_search(
        ...
        try:
            ...
            logger.error("Error during async search", exc_info=True)
            raise
    ...
    async def async_drop(self) -> None:
        ...
        if await self.async_exists():
            try:
                ...
                logger.error("Error dropping collection asynchronously", exc_info=True)
                raise
    ...
    async def async_exists(self) -> bool:
        ...
        try:
            ...
            logger.error("Error checking collection existence asynchronously", exc_info=True)
            return False
    ...
    async def async_name_exists(self, name: str) -> bool:
        ...
        try:
            ...
            logger.error("Error checking document name existence asynchronously", exc_info=True)
            return False
    ...
    def delete_by_name(self, name: str) -> bool:
        ...
        try:
            ...
            logger.error(f"Error deleting documents with name '{name}'", exc_info=True)
            return False
    ...
    def delete_by_metadata(self, metadata: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            logger.error(f"Error deleting documents with metadata '{metadata}'", exc_info=True)
            return False
    ...
    def delete_by_content_id(self, content_id: str) -> bool:
        ...
        try:
            ...
            logger.error(f"Error deleting documents with content_id '{content_id}'", exc_info=True)
            return False
