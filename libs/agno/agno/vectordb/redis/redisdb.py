...
class RedisDB(VectorDb):
    ...
    def create(self) -> None:
        ...
        try:
            ...
            log_error("Error creating Redis index", exc_info=True)
            raise
    ...
    def name_exists(self, name: str) -> bool:
        ...
        try:
            ...
            log_error("Error checking if name exists", exc_info=True)
            return False
    ...
    def id_exists(self, id: str) -> bool:
        ...
        try:
            ...
            log_error("Error checking if ID exists", exc_info=True)
            return False
    ...
    def content_hash_exists(self, content_hash: str) -> bool:
        ...
        try:
            ...
            log_error("Error checking if content hash exists", exc_info=True)
            return False
    ...
    def search(
        ...
        try:
            ...
            log_error("Error in search", exc_info=True)
            return []
    ...
    def vector_search(self, query: str, limit: int = 5) -> List[Document]:
        ...
        try:
            ...
            log_error("Error in vector search", exc_info=True)
            return []
    ...
    def keyword_search(self, query: str, limit: int = 5) -> List[Document]:
        ...
        try:
            ...
            log_error("Error in keyword search", exc_info=True)
            return []
    ...
    def hybrid_search(self, query: str, limit: int = 5) -> List[Document]:
        ...
        try:
            ...
            log_error("Error in hybrid search", exc_info=True)
            return []
    ...
    def drop(self) -> bool:  # type: ignore[override]
        ...
        try:
            ...
            log_error("Error dropping Redis index", exc_info=True)
            return False
    ...
    def exists(self) -> bool:
        ...
        try:
            ...
            log_error("Error checking if index exists", exc_info=True)
            return False
    ...
    def delete(self) -> bool:
        ...
        try:
            ...
            log_error("Error deleting Redis index", exc_info=True)
            return False
    ...
    def delete_by_id(self, id: str) -> bool:
        ...
        try:
            ...
            log_error("Error deleting document by ID", exc_info=True)
            return False
    ...
    def delete_by_name(self, name: str) -> bool:
        ...
        try:
            ...
            log_error("Error deleting documents by name", exc_info=True)
            return False
    ...
    def delete_by_metadata(self, metadata: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            log_error("Error deleting documents by metadata", exc_info=True)
            return False
    ...
    def delete_by_content_id(self, content_id: str) -> bool:
        ...
        try:
            ...
            log_error("Error deleting documents by content_id", exc_info=True)
            return False
    ...
    def update_metadata(self, content_id: str, metadata: Dict[str, Any]) -> None:
        ...
        try:
            ...
            log_error("Error updating metadata", exc_info=True)
            raise
