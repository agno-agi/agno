...
class Steps:
    ...
    def execute(
        ...
        try:
            ...
            logger.error("Steps execution failed", exc_info=True)
            return StepOutput(
    ...
    def execute_stream(
        ...
        try:
            ...
            logger.error("Steps streaming failed", exc_info=True)
    ...
    async def aexecute(
        ...
        try:
            ...
            logger.error("Async steps execution failed", exc_info=True)
            return StepOutput(
                step_name=self.name or "Steps",
                content=f"Steps execution failed: {str(e)}",
                success=False,
    ...
    async def aexecute_stream(
        ...
        try:
            ...
            logger.error("Async steps streaming failed", exc_info=True)
            error_result = StepOutput(
                step_name=self.name or "Steps",
                content=f"Steps execution failed: {str(e)}",
                success=False,
