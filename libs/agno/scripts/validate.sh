...
print_heading "Running: mypy ${AGNO_DIR}/agno/vectordb/graphiti --config-file ${AGNO_DIR}/pyproject.toml"
mypy ${AGNO_DIR}/agno/vectordb/graphiti --config-file ${AGNO_DIR}/pyproject.toml
