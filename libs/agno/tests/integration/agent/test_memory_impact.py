...
def test_agent_memory_impact_with_gc_monitoring(agent_storage, memory):
    ...
    try:
        ...
        tracemalloc_analysis = monitor.analyze_tracemalloc()
        ...
        print(f"✅ Memory impact test completed successfully")
...
def test_agent_memory_cleanup_after_session_switch(agent_storage, memory):
    ...
    try:
        ...
        print(f"✅ Session switching memory test completed successfully")
