...
def test_get_messages_from_last_n_runs_basic(shared_db):
    ...
    messages = team_session.get_messages_from_last_n_runs(last_n=2)
...
def test_get_messages_from_last_n_runs_with_last_n_messages(shared_db):
    ...
    messages = team_session.get_messages_from_last_n_runs(last_n_messages=3)
...
def test_get_messages_skip_history_messages(shared_db):
    ...
    messages = team_session.get_messages_from_last_n_runs(skip_history_messages=True)
    ...
    messages_with_history = team_session.get_messages_from_last_n_runs(skip_history_messages=False)
...
def test_get_messages_skip_role(shared_db):
    ...
    messages = team_session.get_messages_from_last_n_runs(skip_role="system")

    assert len(messages) == 3
    assert all(msg.role != "system" for msg in messages)

    # Skip tool messages
    messages_no_tool = team_session.get_messages_from_last_n_runs(skip_role="tool")
...
def test_get_messages_skip_status(shared_db):
    ...
    messages = team_session.get_messages_from_last_n_runs()
    ...
    messages_skip_error = team_session.get_messages_from_last_n_runs(skip_status=[RunStatus.error])
...
def test_get_messages_filter_by_agent_id(shared_db):
    ...
    messages_agent1 = team_session.get_messages_from_last_n_runs(agent_id="agent_1")
    ...
    messages_agent2 = team_session.get_messages_from_last_n_runs(agent_id="agent_2")
...
def test_get_messages_filter_by_team_id(shared_db):
    ...
    messages_team1 = team_session.get_messages_from_last_n_runs(team_id="team_1")
    ...
    messages_team2 = team_session.get_messages_from_last_n_runs(team_id="team_2")
...
def test_get_messages_filter_member_runs(shared_db):
    ...
    messages_leader = team_session.get_messages_from_last_n_runs()
    ...
    # Get member runs
    messages_members = team_session.get_messages_from_last_n_runs(member_runs=True)
...
def test_get_messages_last_n_with_multiple_runs(shared_db):
    ...
    messages_one_run = team_session.get_messages_from_last_n_runs(last_n=1)
...
def test_get_chat_history_skip_roles(shared_db):
    ...
    chat_history = team_session.get_chat_history(skip_roles=["system", "tool"])
