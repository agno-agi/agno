...
class TestCustomExecutionFunctions:
    ...
    def test_simple_custom_execution_non_streaming(self, workflow_storage):
    ...
    def test_agent_based_custom_execution_non_streaming(self, workflow_storage, simple_agent):
    ...
    def test_multi_step_custom_execution_non_streaming(self, workflow_storage):
    ...
    def test_custom_execution_streaming(self, workflow_storage):
    ...
    def test_custom_execution_with_error_handling(self, workflow_storage):
    ...
    def test_custom_execution_with_execution_input_properties(self, workflow_storage):
    ...
    def test_custom_execution_with_none_return(self, workflow_storage):
    ...
    def test_custom_execution_with_empty_string_return(self, workflow_storage):
