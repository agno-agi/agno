...
class TestLoopSteps:
    """Test loop functionality with minimal test cases."""

    def test_basic_loop(self, workflow_storage):
    ...
    def test_loop_streaming(self, workflow_storage):
    ...
    def test_parallel_loop_streaming(self, workflow_storage):
    ...
    @pytest.mark.asyncio
    async def test_async_loop(self, workflow_storage):
    ...
    @pytest.mark.asyncio
    async def test_async_parallel_loop(self, workflow_storage):
