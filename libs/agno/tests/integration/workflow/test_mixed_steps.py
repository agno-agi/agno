...
class TestComplexStepCombinations:
    """Test complex combinations of workflow steps."""

    def test_loop_with_parallel(self, workflow_storage):
    ...
    def test_loop_with_condition(self, workflow_storage):
    ...
    def test_condition_with_loop(self, workflow_storage):
    ...
    def test_parallel_with_loops(self, workflow_storage):
    ...
    def test_nested_conditions_and_loops(self, workflow_storage):
    ...
    def test_parallel_with_conditions_and_loops(self, workflow_storage):
    ...
    @pytest.mark.asyncio
    async def test_async_complex_combination(self, workflow_storage):
    ...
    def test_complex_streaming(self, workflow_storage):
    ...
    def test_router_with_loop(self, workflow_storage):
    ...
    def test_loop_with_router(self, workflow_storage):
    ...
    def test_parallel_with_routers(self, workflow_storage):
    ...
    def test_router_with_condition_and_loop(self, workflow_storage):
