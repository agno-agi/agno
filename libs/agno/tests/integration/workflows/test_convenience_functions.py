...
def test_step_get_chat_history(agent_with_db: Agent):
    """Test step_get_chat_history returns the correct chat history."""
    session_id = str(uuid.uuid4())
...
@pytest.mark.asyncio
async def test_astep_get_chat_history(mock_agent: Agent, async_shared_db: AsyncSqliteDb):
    """Test astep_get_chat_history returns the correct chat history."""
    session_id = str(uuid.uuid4())
