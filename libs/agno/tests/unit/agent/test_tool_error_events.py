...
from agno.run.agent import RunEvent, ToolCallErrorEvent, RunOutput
from agno.run.team import TeamRunEvent, TeamRunOutput, ToolCallErrorEvent as TeamToolCallErrorEvent
...
def test_team_yields_tool_call_error_event(mocker):
    ...
    events = list(team._handle_model_response_chunk(
        session=session,
        run_response=run_response,
