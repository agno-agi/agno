...
class TestMarkdownChunkingSplitOnHeadings:
    """Tests for split_on_headings parameter with bool and int values."""

    def test_split_on_headings_false_uses_size_based_chunking(self):
    ...
    def test_split_on_headings_true_splits_on_all_headings(self):
    ...
    def test_split_on_headings_level_2_splits_on_h1_and_h2(self):
    ...
    def test_split_on_headings_level_1_splits_on_h1_only(self):
    ...
    def test_split_on_headings_level_3_splits_on_h1_h2_h3(self):
    ...
    def test_chunk_metadata_includes_chunk_number(self):
    ...
    def test_chunk_ids_include_chunk_number(self):
    ...
    def test_chunk_ids_use_name_when_no_id(self):
...
class TestMarkdownChunkingValidation:
    """Tests for parameter validation."""

    def test_invalid_heading_level_above_6_raises_error(self):
    ...
    def test_invalid_heading_level_below_1_raises_error(self):
        """split_on_headings must be between 1 and 6."""
        with pytest.raises(ValueError, match="split_on_headings must be between 1 and 6"):
            MarkdownChunking(split_on_headings=0)

    def test_negative_heading_level_raises_error(self):
        """Negative heading levels should raise ValueError."""
        with pytest.raises(ValueError, match="split_on_headings must be between 1 and 6"):
            MarkdownChunking(split_on_headings=-1)

    def test_valid_heading_levels_1_to_6_accepted(self):
...
class TestMarkdownChunkingEdgeCases:
    ...
    def test_content_smaller_than_chunk_size_returns_single_chunk(self):
    ...
    def test_no_headings_with_split_on_headings_true(self):
    ...
    def test_only_lower_level_headings_with_high_split_level(self):
...
"""
    ...
    def test_mixed_heading_levels_with_level_4_split(self):
