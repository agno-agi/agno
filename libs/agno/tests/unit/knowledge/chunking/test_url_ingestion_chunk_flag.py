...
def test_sync_html_url_uses_default_website_reader_without_download(monkeypatch):
...
@pytest.mark.asyncio
async def test_async_html_url_uses_default_website_reader_without_download(monkeypatch):
