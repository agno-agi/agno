"""
Comprehensive Model String Tests
===============================

Tests to ensure model string functionality works across all providers.
"""

import pytest
from typing import Type
from agno.models.base import Model
from agno.models.utils import create_model, get_model_string, PROVIDERS
...
class TestModelStringProviders:
    """Test model string functionality for all providers."""
    ...
    @pytest.mark.parametrize("provider,module_info", list(PROVIDERS.items()))
    def test_provider_mapping_correctness(self, provider, module_info):
        """Test that provider mappings are correct."""
        module_path, class_name = module_info
        
        # Test that the mapping is correct
        assert isinstance(module_path, str)
        assert isinstance(class_name, str)
        assert "agno.models." in module_path
        ...
        try:
            ...
            # Test that it's actually a Model subclass
...
class TestAgentModelStrings:
    ...
    def test_agent_backward_compatibility(self):
        ...
        try:
            ...
            assert type(old_agent.model) == type(new_agent.model)
...
class TestTeamModelStrings:
    ...
    def test_team_backward_compatibility(self):
        ...
        try:
            ...
            assert type(old_team.model) == type(new_team.model)
