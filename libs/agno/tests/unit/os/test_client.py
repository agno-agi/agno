...
class TestAgentOSClientInit:
    """Test AgentOSClient initialization."""
...
class TestAgentOSClientContextManager:
...
class TestAgentOSClientHeaders:
...
class TestAgentOSClientHTTPMethods:
...
class TestAgentOSClientSessions:
...
class TestAgentOSClientEvals:
    """Test eval operations."""

    @pytest.mark.asyncio
    async def test_list_eval_runs(self):
    ...
    @pytest.mark.asyncio
    async def test_get_eval_run(self):
...
class TestAgentOSClientKnowledge:
    ...
    @pytest.mark.asyncio
    async def test_get_knowledge_config(self):
...
class TestAgentOSClientLazyConnection:
    """Test lazy HTTP client initialization."""

    @pytest.mark.asyncio
    async def test_get_creates_client_lazily(self):
    ...
    @pytest.mark.asyncio
    async def test_post_creates_client_lazily(self):
