...
def _make_paged_get_schedules(schedules):
    ...
    def _get_schedules(enabled=None, limit=100, page=1, raise_on_error=False):
        offset = (page - 1) * limit
...
class TestManagerListAll:
    def test_list_all_pages_past_first_page(self, mgr, mock_db):
        ...
        mock_db.get_schedules.assert_called_with(enabled=None, limit=100, page=2, raise_on_error=True)
    ...
    def test_list_all_empty_table_returns_empty_list(self, mgr, mock_db):
        ...
        assert mgr.list_all() == []
        mock_db.get_schedules.assert_called_once_with(enabled=None, limit=100, page=1, raise_on_error=True)

    def test_list_all_forwards_flags(self, mgr, mock_db):
        mock_db.get_schedules = MagicMock(return_value=([], 0))
        mgr.list_all(enabled=True, raise_on_error=False)
        mock_db.get_schedules.assert_called_once_with(enabled=True, limit=100, page=1, raise_on_error=False)
...
class TestAsyncListAll:
    ...
    async def test_alist_all_pages_past_first_page(self, async_mgr, mock_async_db):
        ...
        mock_async_db.get_schedules.assert_called_with(enabled=None, limit=100, page=2, raise_on_error=True)
    ...
    async def test_alist_all_empty_table_returns_empty_list(self, async_mgr, mock_async_db):
        ...
        mock_async_db.get_schedules.assert_called_once_with(enabled=None, limit=100, page=1, raise_on_error=True)
    ...
    async def test_alist_all_forwards_flags(self, async_mgr, mock_async_db):
        ...
        mock_async_db.get_schedules.assert_called_once_with(enabled=True, limit=100, page=1, raise_on_error=False)
