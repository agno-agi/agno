...
# News Search Tests
def test_serper_search_news_no_api_key():
    """Calling serper_search_news without any API key returns an error message."""
    tools = SerperTools(api_key=None)
...
def test_serper_search_news_empty_query(api_tools):
    """Calling serper_search_news with an empty query returns an error message."""
...
def test_serper_search_news_success(api_tools, mock_news_response):
...
def test_serper_search_news_with_custom_num_results(api_tools, mock_news_response):
...
def test_serper_search_news_exception(api_tools):
