...
class TestTelegramToolsInit:
    def test_default_registers_send_message_only(self, monkeypatch):
        ...
        assert "send_telegram_message" in tools.functions
        assert "send_telegram_photo" not in tools.functions
    ...
    def test_react_disabled_by_default(self, monkeypatch):
        ...
        tools = TelegramTools(chat_id="12345")
        assert "react_telegram_emoji" not in tools.functions
    ...
    def test_react_enabled(self, monkeypatch):
        ...
        assert "react_telegram_emoji" in tools.functions
...
class TestReactWithEmoji:
    def test_success(self, monkeypatch):
        ...
        result = tools.react_telegram_emoji(message_id=42, emoji="👍")
...
def test_pin_telegram_message_success(monkeypatch):
    monkeypatch.setenv("TELEGRAM_TOKEN", "fake-token")
    from agno.tools.telegram import TelegramTools
...
def test_pin_telegram_message_silent(monkeypatch):
    monkeypatch.setenv("TELEGRAM_TOKEN", "fake-token")
    from agno.tools.telegram import TelegramTools
...
def test_pin_telegram_message_api_error(monkeypatch):
    monkeypatch.setenv("TELEGRAM_TOKEN", "fake-token")
    from agno.tools.telegram import TelegramTools
...
def test_get_telegram_chat_success(monkeypatch):
    monkeypatch.setenv("TELEGRAM_TOKEN", "fake-token")
    from agno.tools.telegram import TelegramTools
...
def test_get_telegram_chat_api_error(monkeypatch):
    monkeypatch.setenv("TELEGRAM_TOKEN", "fake-token")
    from agno.tools.telegram import TelegramTools
...
def test_get_telegram_file_success_base64(monkeypatch):
    monkeypatch.setenv("TELEGRAM_TOKEN", "fake-token")
    from agno.tools.telegram import TelegramTools
...
def test_get_telegram_file_save_downloads_to_disk(monkeypatch, tmp_path):
    monkeypatch.setenv("TELEGRAM_TOKEN", "fake-token")
    from agno.tools.telegram import TelegramTools
...
def test_get_telegram_file_output_directory_implies_save_downloads(monkeypatch, tmp_path):
    monkeypatch.setenv("TELEGRAM_TOKEN", "fake-token")
    from agno.tools.telegram import TelegramTools
...
def test_get_telegram_file_api_error(monkeypatch):
    monkeypatch.setenv("TELEGRAM_TOKEN", "fake-token")
    from agno.tools.telegram import TelegramTools
