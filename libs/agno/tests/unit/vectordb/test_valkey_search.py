...
def test_search_documents(valkey_search, sample_documents, mock_valkey_client):
    ...
    mock_search_result = [
        ...
        [
            b"content", b"Tom Kha Gai is a Thai coconut soup with chicken",
            b"metadata", b'{"cuisine": "Thai", "type": "soup"}',
            b"id", b"tom_kha",
            b"__vector_score", b"0.1234"
        ],
        b"doc:test_collection:green_curry",  # doc key 2
        [
            b"content", b"Green curry is a spicy Thai curry with coconut milk",
            b"metadata", b'{"cuisine": "Thai", "type": "curry"}',
            b"id", b"green_curry",
            b"__vector_score", b"0.2345"
        ]
    ]
...
def test_search_with_filters(valkey_search, mock_valkey_client):
    ...
    mock_search_result = [
        ...
        [
            b"content", b"Tom Kha Gai is a Thai coconut soup",
            b"metadata", b'{"cuisine": "Thai", "type": "soup"}',
            b"id", b"tom_kha",
            b"__vector_score", b"0.1234"
        ]
