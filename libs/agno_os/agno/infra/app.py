...
class InfraApp(InfraBase):
    ...
    # If None, PYTHONPATH is set to os_root
    ...
    def add_app_properties_to_resources(self, resources: List[InfraResource]) -> List[InfraResource]:
        ...
        for resource in resources:
            ...
            # If os_settings on resource is not set, use app level os_settings (if set on app)
            if resource.os_settings is None and self.os_settings is not None:
