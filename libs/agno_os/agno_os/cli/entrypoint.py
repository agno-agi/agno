...
from agno_os.cli.os_cli import os_cli as os_subcommands
from agno_os.utils.logging import set_log_level_to_debug
...
def config(
    ...
    from agno_os.cli.console import log_config_not_available_msg
    from agno_os.cli.operator import initialize_agno_cli
...
def set(
    ...
    """
    from agno_os.os.operator import set_os_as_active
...
def start(
    ...
    from agno_os.cli.config import AgnoCliConfig
    from agno_os.cli.console import log_config_not_available_msg
    from agno_os.cli.operator import initialize_agno_cli, start_resources
...
def stop(
    ...
    from agno_os.cli.config import AgnoCliConfig
    from agno_os.cli.console import log_config_not_available_msg
    from agno_os.cli.operator import initialize_agno_cli, stop_resources
...
def patch(
    ...
    from agno_os.cli.config import AgnoCliConfig
    from agno_os.cli.console import log_config_not_available_msg
    from agno_os.cli.operator import initialize_agno_cli, patch_resources
