...
def start_resources(
    ...
    resource_groups_to_create: List[InfraResources] = OSConfig.get_resources_from_file(
...
def stop_resources(
    ...
    resource_groups_to_shutdown: List[InfraResources] = OSConfig.get_resources_from_file(
        resource_file=resources_file_path,
        env=target_env,
        infra=target_infra,
        order="create",
...
def patch_resources(
    ...
    resource_groups_to_patch: List[InfraResources] = OSConfig.get_resources_from_file(
        resource_file=resources_file_path,
        env=target_env,
        infra=target_infra,
        order="create",
