...
from agno_os.cli.config import AgnoCliConfig
from agno_os.cli.console import (
    console,
...
from agno_os.os.enums import OSStarterTemplate
from agno_os.infra.resources import InfraResources
from agno_os.os.config import OSConfig
...
def create_os_from_template(
    ...
    from agno_os.cli.operator import initialize_agno_cli
    from agno_os.os.helpers import get_os_infra_dir_path
    from agno_os.utils.filesystem import rmdir_recursive
    from agno_os.utils.git import GitCloneProgress
...
def setup_os(os_root_path: Path) -> Optional[OSConfig]:
    ...
    from agno_os.cli.operator import initialize_agno_cli
    from agno_os.os.helpers import get_os_infra_dir_path
    from agno_os.utils.git import get_remote_origin_for_dir
