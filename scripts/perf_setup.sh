...
echo -e "    ${DIM}Run everything:${NC} python cookbook/performance/run_all.py --all"
echo -e "    ${DIM}Agno only:${NC}      python cookbook/performance/run_all.py"
echo -e "    ${DIM}Quick smoke:${NC}    python cookbook/performance/run_all.py --all --quick"
echo ""
